...
public class Lodz extends Pojazd implements Plywajacy{
    ...
    public Lodz(String nazwa, double objetosc, int pojemnoscSilnika, String typPojazdu, String typSilnika, Silnik silnik) {
        super(nazwa, objetosc, pojemnoscSilnika, typPojazdu, typSilnika);
        this.silnik = silnik;
    }

    public Lodz(String nazwa, double dlugosc, double szerokosc, double wysokosc, int pojemnoscSilnika, String typPojazdu, String typSilnika, Silnik silnik) {
